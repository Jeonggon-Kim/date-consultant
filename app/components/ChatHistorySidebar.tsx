...
export default function ChatHistorySidebar({
  ...
  return (
    <div className="w-64 bg-gradient-to-b from-rose-100 to-pink-100 h-screen p-4 overflow-y-auto border-r-2 border-rose-200">
      <button
        onClick={onNewChat}
                ...
                <div className="flex items-start justify-between">
                  ...
                  <button
                    ...
                    className={`menu-toggle ml-2 p-1 rounded hover:bg-opacity-20 hover:bg-gray-500 transition-colors ${
                      currentChatId === room.id ? 'text-white' : 'text-gray-500'
                    }`}
                  >
